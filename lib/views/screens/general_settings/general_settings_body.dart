...
class GeneralSettingsBody extends StatelessWidget {
  const GeneralSettingsBody({Key? key, this.animationController}) : super(key: key);
          ...
          SettingMenu(
            ...
            animation: Tween<double>(begin: 0.0, end: 1.0).animate(
              CurvedAnimation(
                ...
                curve: const Interval((1 / 1) * 0, 1.0, curve: Curves.fastOutSlowIn),
              ),
            ),
            text: 'Factory Reset',
            onPressed: () => Navigator.of(context).pushNamed(FactoryResetScreen.routeName),
          )
        ],
      ),
    );
