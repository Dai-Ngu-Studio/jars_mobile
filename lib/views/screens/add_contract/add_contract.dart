...
class AddContractScreen extends StatefulWidget {
  ...
  static const String routeName = '/add-contract';
...
class _AddContractScreenState extends State<AddContractScreen> {
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Text(
                          DateFormat("EE dd, MMMM, yyyy").format(selectedStartDate),
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Text(
                          DateFormat("EE dd, MMMM, yyyy").format(selectedEndDate),
                          style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600),
                        ),
                      ),
                    ],
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  if (await addContract(imageUrl: imageUrl, scheduleType: scheduleFromDropDown)) {
  ...
  Future<void> _selectStartDate(BuildContext context) async {
    ...
    if (pickedStartDate != null && pickedStartDate != selectedStartDate) {
      setState(() => selectedStartDate = pickedStartDate);
    }
  }
  ...
  Future<bool> addContract({String? imageUrl, int? scheduleType}) async {
    ...
    if (imageUrl == null && _descriptionController.text.isEmpty) {
      ...
      return await _contractVM.addContract(token: idToken, contract: inputContract);
    }
    Fluttertoast.showToast(
