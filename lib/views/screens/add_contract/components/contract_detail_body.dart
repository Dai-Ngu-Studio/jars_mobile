...
class DetailContractBody extends StatefulWidget {
  const DetailContractBody({Key? key, this.contractId}) : super(key: key);
...
class _DetailContractBodyState extends State<DetailContractBody> {
  ...
  final contractVM = ContractViewModel();
  ...
  Future<Map<String, dynamic>> getData() async {
    ...
    var contract = await contractVM.getContract(idToken: idToken, contractID: widget.contractId!);
                              ...
                              Material(
                                ...
                                child: InkWell(
                                  child: DropdownButton(
                                    ...
                                    items: ['Daily', 'Weekly', 'Monthly', 'Demo']
                            ...
                            ? snapshot.data!['contract'].note != null
                                ? snapshot.data!['contract'].note.image != null
                                    ? SizedBox(
                                        ...
                                        child: Image.network(
                                            snapshot.data!['contract'].note.image.toString()),
                                      )
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          updateContract(contract: contractDetail);
                        },
  ...
  Future updateContract({Contract? contract}) async {
    ...
    await contractVM.updateContract(
      idToken: idToken,
